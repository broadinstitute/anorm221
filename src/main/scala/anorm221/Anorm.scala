...
trait Row {
  ...
  protected[anorm221] val data: List[Any]
  ...
  private[anorm221] def get1(a: String): MayErr[SqlRequestError, Any] = {
    for (
  ...
  private[anorm221] def getAliased(a: String): MayErr[SqlRequestError, Any] = {
    for (
